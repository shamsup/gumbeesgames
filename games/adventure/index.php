...
<head>
<title>Adventure Games - GumbeesGames.com</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<META Name="revisit-after" Content="3 Days">
<META Name="Description" Content="Free adventure and rpg flash games available to play any time, anywhere.">
<META Name="Keywords" Content="adventure, rpg, free rpg, flash rpg, dungeon, hamster ball, space, fun rpg, online flash, online rpg, games">
<?php
...
?>
  ...
  <?
                    ...
                    $query="SELECT * FROM games WHERE category='adventure' ORDER BY name ASC";
                    $result=mysql_query($query);

                    $num=mysql_numrows($result);
                    echo "<h3 align=\"left\">Adventure Games - ".$num."</h3>";
