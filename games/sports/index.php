...
<head>
<title>Sports Games - GumbeesGames.com</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<META Name="revisit-after" Content="3 Days">
<META Name="Description" Content="Free sports flash games available to play any time, anywhere.">
<META Name="Keywords" Content="sports games, flash sports, flash games, free sports, online sports, hockey, bike, dirt bike, ma balls, pool, knock-out, boxing, foosball, soccer, dare">
<?php
...
?>
  ...
  <?
                    ...
                    $query="SELECT * FROM games WHERE category='sports' ORDER BY name ASC";
                    $result=mysql_query($query);

                    $num=mysql_numrows($result);
                    echo "<h3 align=\"left\">Sports Games - ".$num."</h3>";
