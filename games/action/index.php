...
<head>
<title>Action Games - GumbeesGames.com</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<META Name="revisit-after" Content="3 Days">
<META Name="Description" Content="Free action flash games available to play any time, anywhere.">
<META Name="Keywords" Content="action, shooting, alias 3, alien hunter, arsenal, battle, fight, action, gun, gunner, conquer, mob, ninja, warrior, soldier">
<?php
...
?>
  ...
  <?
                    ...
                    $query="SELECT * FROM games WHERE category='action' ORDER BY name ASC";
                    $result=mysql_query($query);

                    $num=mysql_numrows($result);
                    echo "<h3 align=\"left\">Action Games - ".$num."</h3>";
