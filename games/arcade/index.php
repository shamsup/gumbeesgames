...
<head>
<title>Arcade Games - GumbeesGames.com</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<META Name="revisit-after" Content="3 Days">
<META Name="Description" Content="Free arcade flash games available to play any time, anywhere.">
<META Name="Keywords" Content="arcade games, free arcade, free games, flash arcade, truck adventure, tower defense, wiggi, rapidz, maximus, flash game, free flash">
<?php
...
?>
  ...
  <?
                    ...
                    $query="SELECT * FROM games WHERE category='arcade' ORDER BY name ASC";
                    $result=mysql_query($query);

                    $num=mysql_numrows($result);
                    echo "<h3 align=\"left\">Arcade Games - ".$num."</h3>";
